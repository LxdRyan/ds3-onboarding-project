...
INSERT INTO TASKS (id, name, contents, creator_id, due_date, status, priority) VALUES (1,'Testing_high', 'testing task', 0, '2025-05-03', 'Completed', 'High');
INSERT INTO TASKS (id, name, contents, creator_id, due_date, status, priority) VALUES (1,'Testing_medium', 'testing task', 0, '2025-05-03', '', 'Medium');